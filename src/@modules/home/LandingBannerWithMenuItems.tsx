  ...
  return (
    <section>
      <div className="grid lg:grid-cols-8">
        <div className="col-span-2 hidden lg:flex items-center gap-4 px-2 xl:px-4 py-2.5 ">
          <IoMenu className="w-6 h-auto xl:w-7 xl:h-7" />
          <p className="font-semibold text-base xl:text-lg uppercase">
            Shop By Category
          </p>
        </div>
        <div className="col-span-6 flex flex-wrap items-center  gap-0">
          {[
            "Offers",
            "Products",
            "Corporate",
            ...
            <div key={item} className="md:flex items-center ">
              <p
                className={cn(
                  "px-2 xl:px-4 py-2.5 text-base xl:text-lg font-semibold",
